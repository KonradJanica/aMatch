...
//                setResult(Activity.RESULT_OK, resultIntent);
    ...
    private void setupSimplePreferencesScreen() {
        ...
        PreferenceCategory headerMisc = new PreferenceCategory(this);
        headerMisc.setTitle(R.string.pref_misc_header);
        getPreferenceScreen().addPreference(headerMisc);
        addPreferencesFromResource(R.xml.pref_misc);

        bindPreferenceSummaryToValue(findPreference("fling_speed"));
